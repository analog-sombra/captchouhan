    ...
    <section className="w-full bg-[#e8d9b8] py-20">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-3">Instagram Reels</h2>
          <p className="text-gray-600">Check out our latest reels and stories</p>
        </div>
