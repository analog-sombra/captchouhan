    ...
    <section className="w-full bg-linear-to-b from-slate-50 to-white py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Need special approvals, complex clearances, or high-level lobbying? I make it happen. With years of experience navigating government channels, securing permits, and executing challenging projects, I specialize in cutting through red tape to get results.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-24">
          ...
          >
            <div className="bg-white p-8 lg:p-10 rounded-2xl shadow-xl">
              ...
              >
                <p>
                  I have successfully navigated complex bureaucratic landscapes through strategic negotiation and communication with Chief Ministers, state leaders, Defence officials, and regulators like ASI, PESO, MoHUA, MoT, and SRA—securing approvals for projects that seemed impossible.
                </p>
              </motion.div>
